import cat1 from '../../assets/images/booksImages/And-there-was-light_.jpg'
const Suggested = () => {
                    ...
                    'responsive': {
                        ...
                        <div className="home-slide">
                            <a href="demo25-shop.html">
                                <img src={cat1} alt="slider" width={545} height={398} />
                            ...
                            <div className="product-default">
                                <figure>
                                    <img src={cat1} alt="product" width={250} height={375} />
                                </figure>
                            ...
                            <div className="col-md-4">
                                <div className="banner banner1 bg-white">
                                    <div className="banner-layer d-flex flex-column align-items-center justify-content-center h-100">
                                        ...
                                        <figure>
                                            <img src={cat1} alt="banner" width={343} height={283} />
                                        </figure>
                                        ...
                                        <div className="product-default inner-quickview inner-icon">
                                            <figure>
                                                <a href="demo25-product.html">
                                                    <img src={cat1} width={217} height={217} alt="product" />
                                                </a>
