            ...
            <div className="postsDiv">
                ...
                <div className="postContent">
                    ...
                    <div className="buttons-div-p">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" className="bi bi-hand-thumbs-up" viewBox="0 0 16 16">
                    ...
                    <div className="commentsDivPost displayFlexRow">
                        {/* { (commentStatus && (post.id==commentID))&& <Comments postID={post.id}/> } */}
                    </div>          
                </div>
            </div>
        </>
