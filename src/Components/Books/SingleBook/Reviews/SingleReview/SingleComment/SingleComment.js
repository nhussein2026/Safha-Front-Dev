...
const SingleComment = ({comment, i, usersInfo}) => {
        ...
        <>
            <div key={i} className="postsDiv">
                <div className="topPart">
                    <div className="avatarClassComment">
                        {
                            usersInfo.map((userInfo)=>{
                                if(userInfo.userId == commentInfo?.userId){
                                return(
                ...
                <div className="postContent">
                    <div className="desArea">
                        <p className="postContentText">{commentInfo?.content}</p>
                    </div>
                    <div className="buttons-div-p">
                        <div className="like-posts displayFlexRow" >
